...
public class TopCoursesItemAdapter extends RecyclerView.Adapter<TopCoursesItemAdapter.MyViewHolder> {
    ...
    public TopCoursesItemAdapter(Context context, List<CourseList> courses) {
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
        ...
        final CourseList course = courses.get(position);
...
// Add the buttons
        ...
        if (position >= getItemCount() - 15 && isMoreDataAvailable && !isLoading && loadMoreListener != null) {
            ...
            Log.d("TopcoursesAdapter", "loadMore called");
        }
    }
