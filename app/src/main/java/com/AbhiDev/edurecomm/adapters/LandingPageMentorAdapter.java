...
public class LandingPageMentorAdapter extends RecyclerView.Adapter<LandingPageMentorAdapter.MyViewHolder>  {
    private Context context;
    private LayoutInflater inflater;
    List<Mentor> ambassdorsDatas;

    public LandingPageMentorAdapter(Context context, List<Mentor> ambassdorsDatas) {
    ...
    @Override
    public LandingPageMentorAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view=inflater.inflate(R.layout.mentor_landing_page_item,parent,false);
        return new LandingPageMentorAdapter.MyViewHolder(view);
    }

    @Override
    public void onBindViewHolder(final LandingPageMentorAdapter.MyViewHolder holder, int position) {
